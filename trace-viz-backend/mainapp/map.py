...
#     # Plot the locations with different colors based on the city name
#     for loc in locations:
#         city = loc[3]
#         color = city_colors[city]
#         folium.Marker(location=validate_location(loc[:2]), icon=folium.Icon(color=color)).add_to(m)

#     # Plot the path between consecutive locations with different colors based on the city name
...
#     m.save('playground/templates/map.html')
